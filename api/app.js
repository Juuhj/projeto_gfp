...
// Rotas Transacoes
// testar
// app.post('/LocalTransacao', rotasTransacoes.novaTransacao)
// app.get('/LocalTransacao/listarTodos', rotasTransacoes.listarTodos)
// app.get('/LocalTransacao/:id_local_transacao', rotasTransacoes.consultarPorId)
// app.put('/LocalTransacao/atualizarTodos/:id_local_transacao', rotasTransacoes.atualizarTodosCampos)
// app.patch('/LocalTransacao/atualizar/:id_local_transacao', rotasTransacoes.atualizar)
// app.patch('/LocalTransacao/desativar/:id_local_transacao', rotasTransacoes.desativar)
// app.patch('/LocalTransacao/reativar/:id_local_transacao', rotasTransacoes.reativar);
// app.delete('/LocalTransacao/deletar/:id_local_transacao', rotasTransacoes.deletar)
